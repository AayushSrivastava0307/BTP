...
`define  WIGHT_SHIFT 	31

// Left shift applied to a raw 0..255 pixel byte to place it in Q7.24.
//  Q7.8 a raw byte was already correct no need for this shift at Q7.24 it needs p*2^16 shift
`define  PIXEL_SHIFT	16
...
//   OUTPUT_NUM_CONV2    16  logical channel count, used for all downstream widths
//   OUTPUT_NUM_CONV2_P   4  channels computed per pass == parallel acc units
`define OUTPUT_BATCH_CONV2  4
`define OUTPUT_NUM_CONV2   	16
`define OUTPUT_NUM_CONV2_P 	4
